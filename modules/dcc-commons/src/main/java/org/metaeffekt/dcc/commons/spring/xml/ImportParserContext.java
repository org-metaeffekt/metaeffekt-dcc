...
/**
 * Simple bean to store additional information while parsing.
 */
public class ImportParserContext {
    ...
    public void setProcessedImports(Set<String> processedImports) {
        this.processedImports = processedImports;
    }
}
