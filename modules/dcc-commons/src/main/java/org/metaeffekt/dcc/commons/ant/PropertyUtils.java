...
public class PropertyUtils {
    ...
    public static String escapePropertyValue(String value) {
        ...
        try {
            ...
            final String string = new String(baos.toString(StandardCharsets.ISO_8859_1.name()));
            return string.substring(string.indexOf("=") + 1).trim();
        } catch (IOException e) {
            throw new IllegalStateException("Cannot escape property value" + value, e);
        }
    }

    public static Properties loadEnrichedProperties(Project project, File propertyFile) throws BuildException {
        try (FileReader reader = new FileReader(propertyFile)) {
            ...
            throw new BuildException(
                    "Execution properties not found. Check root cause below for details.", e);
        }
    }
}
