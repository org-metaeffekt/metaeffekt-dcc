...
rem DEPRECATED use dcc-shell.bat instead
...
java -Xmx1024m -Dflash.message.disabled=false -Djline.nobell=true -Droo.console.ansi=true -cp "%DCC_CP%" org.metaeffekt.dcc.shell.DccShell %*
