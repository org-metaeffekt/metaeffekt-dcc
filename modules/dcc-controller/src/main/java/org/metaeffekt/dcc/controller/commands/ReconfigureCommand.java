 ...
 */
public class ReconfigureCommand extends AbstractUnitBasedCommand {

    public ReconfigureCommand(ExecutionContext executionContext) {
        super(executionContext);
    }

    @Override
    protected Commands getCommandVerb() {
        return Commands.RECONFIGURE;
    }
