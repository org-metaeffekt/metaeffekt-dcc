 ...
 */
public class EvaluateTemplatesCommand extends AbstractHostBasedCommand {

    public EvaluateTemplatesCommand(ExecutionContext executionContext) {
        super(executionContext);
    }

    @Override
    public Commands getCommandVerb() {
        return Commands.EVALUATE_TEMPLATES;
    }

    @Override
    protected void doExecuteCommand(Executor executor) {
        executor.evaluateTemplateResources();
    }
