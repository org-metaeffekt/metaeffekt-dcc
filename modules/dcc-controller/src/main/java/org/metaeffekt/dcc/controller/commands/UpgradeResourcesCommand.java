...
public class UpgradeResourcesCommand extends AbstractUnitBasedCommand {
    
    private final File upgradePropertiesFile;

    public UpgradeResourcesCommand(ExecutionContext executionContext, File upgradePropertiesFile) {
    ...
    public Commands getCommandVerb() {
        return Commands.UPGRADE_RESOURCES;
    }

    @Override
    protected void doExecuteCommand(ConfigurationUnit unit) {
        getExecutor(unit).upgradeResources(unit, upgradePropertiesFile);
    }
