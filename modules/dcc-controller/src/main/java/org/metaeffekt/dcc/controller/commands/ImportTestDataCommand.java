 ...
 * @author Alexander D.
 */
public class ImportTestDataCommand extends AbstractUnitBasedCommand {

    public ImportTestDataCommand(ExecutionContext executionContext) {
        super(executionContext);
    }

    @Override
    protected Commands getCommandVerb() {
        return Commands.IMPORT_TEST_DATA;
    }
}
