...
public class ExecuteProfileCommands extends AbstractExecutionCommands {
    ...
    public void executeInitialize(
        ...
        executeCommand(new EvaluateTemplatesCommand(executionContext), true, false, unitId);
        
        executeCommand(new InitializeResourcesCommand(executionContext), force, false, unitId);
        executeCommand(new InitializeCommand(executionContext), force, true, unitId);
        executeCommand(new VerifyCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeInitializeResources(
        ...
        executeCommand(new EvaluateTemplatesCommand(executionContext), force, false, unitId);
        executeCommand(new InitializeResourcesCommand(executionContext), force, false, unitId);
    }

    @CliCommand(value = "execute clean", help = "Clean the temporary area on the hosts referenced by the selected profile.")
    public void executeClean(@CliOption(key = "unitId", mandatory = false, optionContext = UnitCapabilityIdConverter.USE_UNIT_ID_COMPLETION, help = HELP_UNITID)
        String unitId) {
        executeCommand(new CleanCommand(executionContext), true, false, unitId);
    }
    ...
    public void executeInstall(
        ...
        executeCommand(new InstallCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeUninstall(
        ...
        executeCommand(new UninstallCommand(executionContext), force, false, unitId);
        
        // in case a unit id is provided the uninstall was focussed on the unit only. In this case a purge is
        // not applicable.
        if (unitId == null) {
            executeCommand(new PurgeCommand(executionContext), force, false, unitId);
        }
    }
    ...
    public void executeConfigure(
        ...
        executeCommand(new ConfigureCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeDeploy(
        ...
        executeCommand(new DeployCommand(executionContext), force, false, unitId);
    }
    ...
    public void executePreparePersistence(
        ...
        executeCommand(new PreparePersistenceCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeBootstrap(
        ...
        executeCommand(new BootstrapCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeImport(
        ...
        executeCommand(new ImportCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeImportTestData(
        ...
        executeCommand(new ImportTestDataCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeUpload(
        ...
        executeCommand(new UploadCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeReconfigure(
        ...
        executeCommand(new InitializeCommand(executionContext), force, true, unitId);
        executeCommand(new ReconfigureCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeStart(
        ...
        executeCommand(new StartCommand(executionContext), force, false, unitId);
    }
    ...
    public void executeStop(
        ...
        executeCommand(new StopCommand(executionContext), force, false, unitId);
    }
