...
public class InitializeResourcesCommand extends AbstractUnitBasedCommand {

    public InitializeResourcesCommand(ExecutionContext executionContext) {
        super(executionContext);
    }

    @Override
    public Commands getCommandVerb() {
        return Commands.INITIALIZE_RESOURCES;
    }

    @Override
    protected void doExecuteCommand(ConfigurationUnit unit) {
        getExecutor(unit).initializeResources(unit);
    }
